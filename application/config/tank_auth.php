...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Ten in Town';
$config['webmaster_email'] = 'chef@tenintown.com';
...
$config['recaptcha_public_key'] = '6Lfw-cISAAAAACb-k6D0-jRf-4I7zFsNdzALhMaa ';
$config['recaptcha_private_key'] = '	6Lfw-cISAAAAAGv6ebYke9PE8VHJGYXhxFthtavW';
